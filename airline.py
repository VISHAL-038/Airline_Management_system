...
mydb = mysql.connector.connect(user='root', password='rishabh@123',
                              host='localhost',
                              database='hotel')
...
def orderitem():
    ...
    if(d==1):
        ...
        print("you have ordered soft drink")
        a=int(input("enter quantity"))
        s=20*a
        print("your amount for soft drink is :",s,"\n")
    elif(d==4):
        ...
        print("you have ordered pizza roll")
        a=int(input("enter quantity"))
        s=30*a
        print("your amount for pizza roll is :",s,"\n")
    elif(d==7):
        print("you have ordered chicken leg piece")
        a=int(input("enter quantity"))
        s=10*a
        print("your amount for chicken leg piece is :",s,"\n")
    elif(d==8):
